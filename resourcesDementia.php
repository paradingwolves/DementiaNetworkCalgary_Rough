...
<div class="container-lg tests">
    <div class="row mt-4">
        <div class="col-sm-12 col-md-12 col-lg-4 col-xl-4 left-nav">
            ...
            <ul style="padding:0;">
                ...
                <li class="content-nav-item">
                    <a href="resourcesDementia.php#mapOfServices">Map of Services in Calgary</a>
                </li>
                <li class="content-nav-item">
                    <a href="resourcesDementia.php#translatedDocuments">Translated Documents</a>
                </li>
                <li class="content-nav-item">
        ...
        <div class="col-sm-12 col-md-12 col-lg-7 col-xl-7">
            ...
            <section id="WhatIsDementia">
                <h2 class="mt-5 mb-3">What Is Dementia?</h2><br>
                <h5>Looking For Further Information?</h5><br>
                ...
                <div class="container-lg">
                    <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-8 col-lg-11  my-3">
            ...
            <!-- Map of Service in Calgary -->
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12">
                <section id="mapOfServices">
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-12">
                        <h3 class="mt-5 mb-3">Map of Services Calgary</h3><br>
                        <p class="text-dark">For a list of organizations by type, please click on the icon in the top left on the map below:</p>

                        <p class="text-dark">For more information on any location (website, phone number, etc), click on the appropriate location marker.</p><br>
                        <p class="text-dark">If you would like to have your organization added to the map, please email: <a href="mailto:info@dementianetworkcalgary.ca">info@dementianetworkcalgary.ca</a></p>
                    </div>
                    <div class="mapOfServices-frame">
                        <div class="row">
                            <div class="col-md-4 mapOfServices-info">
                                <h4>TYPE:</h4>
                                <ul class="mb-3">
                                    <li>Support groups (maroon)</li>
                                    <li>Adult Day Programs (blue)</li>
                                    <li>Supportive Living (red)</li>
                                    <li>Independent Living with Supports (green)</li>
                                    <li>Home Care (purple)</li>
                                    <li>Overnight Respite (yellow)</li>
                                </ul>
                            </div>
                            <div class="col-md-8 servicesMap">
                                <iframe src="https://www.google.com/maps/d/embed?mid=1pC558af7xtQXNZCncd7B8LQigRc&amp;hl=en_US&amp;ehbc=2E312F" width="100%" height="500px"></iframe>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12">
                    <section id="translatedDocuments">
                        <h2 class="mt-5 mb-1">Translated Documents</h2><br>
                        <h4 class="my-3"><strong>Resource Guide for People at Risk of Going Missing</strong></h4>
                        <div class="row">
                            <div class="col-sm-12 col-md-4 col-lg-3 my-3">
                                <a href="https://dementianetworkcalgary.ca/wp-content/uploads/2022/12/Resource-guide-for-people-at-risk-of-going-missing-Arabic-1.pdf" target="_blank">عربي (Arabic)</a>
                            </div>
                            <div class="col-sm-12 col-md-4 col-lg-3 my-3">
                            ...
                            <div class="col-sm-12 col-md-4 col-lg-3 my-3">
                                <a href="https://dementianetworkcalgary.ca/wp-content/uploads/2022/12/French_Resource-guide-for-people-at-risk-of-going-missing-2-FR.pdf" target="_blank">Français (French)</a>
                            </div>
                            
                            <div class="col-sm-12 col-md-4 col-lg-3 my-3">
                                <a href="https://dementianetworkcalgary.ca/wp-content/uploads/2022/12/FINAL-Resource-guide-for-people-at-risk-of-going-missing-2-German-FINAL.pdf" target="_blank">Deutsch (German)</a>
                            </div>

                            <div class="col-sm-12 col-md-4 col-lg-3 my-3">
                                <a href="https://dementianetworkcalgary.ca/wp-content/uploads/2022/12/PUNJABI-FINAL-Resource-guide-for-people-at-risk-of-going-missing-.pdf" target="_blank">ਪੰਜਾਬੀ (Punjabi)</a>
                            </div>

                            <div class="col-sm-12 col-md-4 col-lg-3 my-3">
                                <a href="https://dementianetworkcalgary.ca/wp-content/uploads/2022/12/Resource-guide-for-people-at-risk-of-going-missing-Tagalog.pdf" target="_blank">Tagalog</a>
                            </div>

                            <div class="col-sm-12 col-md-4 col-lg-3 my-3">
                                <a href="https://dementianetworkcalgary.ca/wp-content/uploads/2022/12/Final-Resource-guide-for-people-at-risk-of-going-missing-Spanish.pdf" target="_blank">Español (Spanish)</a>
                            </div>

                            <div class="col-sm-12 col-md-4 col-lg-3 my-3">
                                <a href="https://dementianetworkcalgary.ca/wp-content/uploads/2022/12/FINAL-Resource-guide-for-people-at-risk-of-going-missing-UKRAINIAN.pdf" target="_blank">Українська (Ukrainian)</a>
                            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    <button id="back-to-top-btn" class="back-to-top-btn btn btn-dark m-5 bg-DNC-dark">
                        Return to Top
                    </button>
                </div>
