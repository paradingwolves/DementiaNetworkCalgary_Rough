    ...
    <div class="container-lg tests">
        <div class="row mt-4">
            <div class="col-sm-12 col-md-12 col-lg-4 left-nav">
                ...
                <ul style="padding:0;">
                    <li class="content-nav-item"><a href="#">Who We are</a></li>
                    <li class="content-nav-item"><a href="#">What We Do</a></li>
                    <li class="content-nav-item"><a href="#">Supporters</a></li>
                    <li class="content-nav-item"><a href="#">Network FAQs</a></li>
                    <li class="content-nav-item"><a href="#">Why It Matters</a></li>
                    <li class="content-nav-item"><a href="#">Collective Impact</a></li>
                    <li class="content-nav-item"><a href="#">Strategy Roadmap</a></li>
                    <li class="content-nav-item"><a href="#">Outcomes & Capabilities</a></li>
                    <li class="content-nav-item"><a href="#">Action</a></li>
                    <li class="content-nav-item"><a href="#">Impact</a></li>
                </ul>
            </div>
